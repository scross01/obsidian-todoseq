...
- Name: table-tasks.test.ts >> Table cell tasks (experimental) >> keyword menu changes table cell task state in Live Preview for cell with description
- Location: tests/integration/table-tasks.test.ts:151:3
...
Expected substring: "DONE Table task two with description"
