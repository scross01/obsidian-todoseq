...
export const en = {
  ...
  datePicker: {
    ...
    repeatFromOriginal: '+ (from original)',
    repeatFromDone: '.+ (from done)',
    repeatCatchUp: '++ (catch up)',
    ...
    clearWarningPeriod: 'Clear warning period',
    cancel: 'Cancel',
    save: 'Save',
  },
  taskList: {
    ...
    taskCount: '{done} of {total} tasks',
    taskCountOne: '{done} of {total} task',
    futureDatedTasksLabel: 'Future dated tasks:',
    taskDescriptionsLabel: 'Task descriptions:',
  },
  dragDrop: {
  ...
  searchOptions: {
    ...
    prefixPath: 'match path of the file',
    prefixFile: 'match file name',
    prefixTag: 'search for tags',
    prefixState: 'match task state',
    prefixPriority: 'match task priority',
    prefixContent: 'match task content',
    prefixScheduled: 'filter by scheduled date',
    prefixDeadline: 'filter by deadline date',
    prefixClosed: 'filter by closed date',
    prefixPageProperty: 'match page property',
  },
  statusBar: {
  ...
  embedded: {
    ...
    allTasks: 'All tasks',
    errorTitle: 'Error rendering task list',
    errorHelp: 'Check your search and sort parameters for syntax errors.',
  },
} as const;
